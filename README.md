...
現代の時計は「常に同じ長さの1時間」を前提にしていますが、江戸時代の人々は、日の出と日の入りを基準に、昼と夜をそれぞれ6つに分けた「不定時法」で時間を捉えていました。 
EdoTime は、この異なる時間感覚を現代の生活の中で可視化し、「時間は絶対的なものではなく、自然や環境と結びついていた」という視点を体験として取り戻すことを目的としています。
単なる歴史再現ではなく、今この瞬間を別の尺度で捉え直すためのツールとして設計されています。
